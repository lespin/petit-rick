...
zzfxV=.3    // volume
zzfx = (RNG,p=1,k=.05,b=220,e=0,r=0,t=.1,q=0,D=1,u=0,y=0,v=0,z=0,l=0,E=0,A=0,F=0,c=0,w=1,m=0,B=0)=>{
        const hash = [p,k,b,e,r,t,q,D,u,y,v,z,l,E,A,F,c,w,m,B]
...
//zzfx(...[,,1178,,.04,.28,,.48,,,41,.1,,.1,,,,.93,.03,.19]); // Pickup 25
export const zzfxCreateAndPlay = zzfx 
